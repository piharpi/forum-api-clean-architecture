...
describe('AddReplyUseCase', () => {
  ...
  it('should orchestrating the add comment action correctly', async () => {
    ...
    expect(mockThreadRepository.checkIsThreadAvailable).toBeCalledWith('thread-123');
    expect(mockCommentRepository.checkIsCommentAvailable).toBeCalledWith('comment-123');
  });
});
