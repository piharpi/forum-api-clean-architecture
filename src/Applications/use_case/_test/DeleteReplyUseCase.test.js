...
describe("DeleteReplyUseCase", () => {
  it("should orchestrating the delete reply action correcty", async () => {
    ...
    mockReplyRepository.checkIsReplyAvailable = jest
      .fn()
      .mockImplementation(() => Promise.resolve());
    ...
    await expect(mockReplyRepository.checkIsReplyAvailable).toBeCalledWith(
      useCasePayload.replyId
    );
    await expect(mockReplyRepository.deleteReply).toBeCalledWith(
      useCasePayload.replyId
    );
  });
});
